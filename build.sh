...
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -o dist/linux_arm64/gofastcopy -ldflags "-w -s" main.go
zip dist/linux_arm64/gofastcopy_linux_arm64.zip dist/linux_arm64/gofastcopy
